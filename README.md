...
https://github.com/victormc13/Hello-world/blob/main/icons/banner.jpg
...
```
git clone https://github.com/Ochiengsteven/Hello-world.git
```
...
- [ ] **Implement a Sign-up page for newsletters.**
- [ ] **Add more pages.**
